...
15. **Formato canónico de ejercicios de Práctica Independiente — el mismo que usa la Práctica Guiada (regla 20), default desde Clase 20.** Cada ejercicio (y la Guiada) sigue esta estructura fija en orden:
    ...
    3. Pistas colapsables con `<details><summary>💡 Pista N — subtítulo</summary>...</details>` — **default siempre desde Clase 24b (2026-08-19), 1-2 por ejercicio a criterio de quien diseña** (antes: solo donde aplica). Cada ejercicio de Práctica Independiente lleva al menos una pista; el criterio de cuántas (1 o 2) y sobre qué punto (un operador que no es el foco de la clase, un paso del patrón general que se presta a confusión, un caso borde) queda a discreción del diseño, no de si "amerita" o no.
