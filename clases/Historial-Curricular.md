...
| **27** | **🎯 Evaluación individual — Ciclos** (for, range, for anidado, while, break/continue) | `clase-27-evaluacion-ciclos` | N/A — evaluación sumativa individual | Spec + Evaluación + Solucionario Docente generados (falta Solucionario Estudiantes, on-demand) — no pusheado, se rinde el 27-ago | **2026-08-27** | OA1, OA3 |
...
| Jueves | 2026-08-27 | N° 27 — 🎯 Evaluación individual — Ciclos (carpeta `clase-27-evaluacion-ciclos`) — Spec + Evaluación + Solucionario Docente generados y verificados (12/12 soluciones), commit local hecho, sin push hasta rendida |
