# Historial curricular — Clases de Python 4to medio

> **Fuente de verdad de lo que efectivamente se ha enseñado**, en el orden y la numeración real que usa Diego — que puede divergir de la numeración del Tutorial Picuino cuando una clase se profundiza, se divide en dos, o se inserta como refuerzo/consolidación.
>
...
> Las filas con estado **Planificada** son el currículo oficial de referencia para el resto del año. Se actualizan a "Spec aprobada" cuando Diego aprueba la spec de cada clase. Las fechas de clases planificadas son aproximaciones por mes.

| N° real | Tema | Carpeta | Clase Picuino de referencia | Estado | Fecha | OAs |
|---|---|---|---|---|---|---|
| 7 | input | `clase-07-input` | N°7 — La función input() | Spec aprobada | 2026-05-16 | OA2, OA3 |
| 8a | Booleanos — comparaciones | `clase-08a-booleano-comparaciones` | N°8 — El tipo Booleano (parte 1) | Spec aprobada | 2026-05-21 | OA1, OA2, OA3 \| OAd |
| 8b | Operadores lógicos | `clase-08b-operadores-logicos` | N°8 — El tipo Booleano (parte 2) | En revisión | 2026-05-30 | OA1, OA3 \| OAd |
| 8c | Análisis de condiciones | `clase-08c-analisis-condiciones` | N/A — clase de consolidación | Spec aprobada | 2026-06-02 | OA1, OA3 \| OAd |
| 11 | if / else | `clase-09-if-else` | N°9 — Sentencia if else | Spec aprobada | 2026-06-05 | OA1, OA3 |
...
| **17** | **Ejercitación Condicionales (if / if anidados / elif)** | `clase-17-ejercitacion-condicionales` | N/A — clase de consolidación (repaso en parejas de if/else, if anidados y elif, con décimas por ejercicio) | ✅ Completa | **2026-07-14** | OA1, OA3 \| OAd |
...
| **28** | **Strings — indexing y slicing** (acotada a acceso por índice + rebanadas — ver Prompt.md) | `clase-28-strings` | N°21, N°22 — Cadenas de texto + índices de cadenas (recorte, ver nota de renumeración 2026-08-26) | Contenidos y objetivo acordados en chat de diseño — spec sin generar | **2026-08-31** | OA2, OA3 |
| **29** | **Strings — recorriendo texto con for** (recorrido directo, con índice, combinado con slicing — clase nueva) | `clase-29-strings-recorrido` | N°22 — Índices de cadenas de texto (recorrido, separado de N°28) | Contenidos acordados en chat de diseño — spec sin generar | **2026-09-01** | OA2, OA3 |
...
| **Lunes** | **2026-08-31** | **N° 28 — Strings: indexing y slicing** (`clase-28-strings`). Ocupa el día que antes tenía la revisión formativa de la Evaluación de Ciclos — **esa revisión se corre a otro día, aún sin fecha (pendiente, Diego la define al terminar de revisar el calendario)**. Contenidos y objetivo acordados en chat de diseño 2026-08-26, spec sin generar |
| Martes | 2026-09-01 | N° 29 — Strings: recorriendo texto con for (`clase-29-strings-recorrido`, clase nueva). Contenidos acordados en chat de diseño 2026-08-26, spec sin generar |
...
| Bloque | Clases | Tema | OAs protagonistas |
|---|---|---|---|
...
> Esta tabla queda congelada como registro de los sets generados bajo la convención antigua (carpeta `ayudantias/`, sin N° real). Desde 2026-07-28 las ayudantías nuevas se registran directamente como una fila más en la tabla principal "Clases dictadas y plan curricular completo" — ver la fila N°21 como primer ejemplo.

| Slug | Clases foco | Tema | Propósito | Fecha |
|---|---|---|---|---|
| `ayudantia-if-else-booleanos` | clase-08a, clase-08b, clase-09 (if/else — real N°11) | Refuerzo if/else y booleanos | Competencia | 2026-06-06 |
