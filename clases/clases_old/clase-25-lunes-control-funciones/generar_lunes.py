"""Genera los notebooks del lunes estandar N°25 (Control Funciones).

Fuente de verdad: "Clase 25 - Lunes Control Funciones - Propuesta.json".
Nunca editar los .ipynb a mano: cambiar el JSON y volver a correr este script.

Produce:
  - Clase 25 - Lunes Control Funciones - Ejercitación.ipynb                    (estudiantes, Colab)
  - Clase 25 - Lunes Control Funciones - Control.ipynb                         (estudiantes, Classroom)
  - Clase 25 - Lunes Control Funciones - Control Solucionario Docente.ipynb    (profesor + agente corrector)
  - Clase 25 - Lunes Control Funciones - Control Solucionario Estudiantes.ipynb (publicar despues de aplicado el control)

Uso:
    python generar_lunes.py            # genera los cuatro notebooks
...
PROPUESTA = BASE / "Clase 25 - Lunes Control Funciones - Propuesta.json"
...
def build_ejercitacion(data: dict) -> dict:
    ...
    cells = [
        md_cell(
            f"# 🔁 Clase {data['class_number']} — Ejercitación: Funciones, return, guardar y reutilizar\n\n"
            f"**Fecha:** {data['fecha']}  \n"
...
def build_control(data: dict) -> dict:
    ...
    cells = [
        md_cell(
            f"# ⚡ Clase {data['class_number']} — Control de Funciones\n\n"
            f"**Fecha:** {data['fecha']}  \n"
            "**Nombre:** _______________________  \n"
            "**Curso:** _______________________\n\n"
            "---"
...
def build_control_solucionario_docente(data: dict) -> dict:
    ...
    cells = [
        md_cell(
            f"# ✅ Solucionario del Control (Docente) — Clase {data['class_number']}: Funciones\n\n"
...
def build_control_solucionario_estudiantes(data: dict) -> dict:
    ...
    cells = [
        md_cell(
            f"# ✅ Solucionario del Control — Clase {data['class_number']}: Funciones\n\n"
