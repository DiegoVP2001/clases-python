...
Estructura de carpetas (desde 2026-07-28, tras crear la réplica atrasada): `Spec.md` e `Historial.md` viven en la raíz de `clase-19-evaluacion-condicionales/` porque documentan ambas versiones; cada versión de la evaluación tiene su propia subcarpeta con su script y sus notebooks.

**`version-dia/`** (evaluación regular, rendida en la fecha original):
...
- `Clase 19 - Evaluación Condicionales - Solucionario Estudiantes.ipynb` — para publicar al curso.
- `generar_evaluacion.py` — script fuente de verdad (no editar los `.ipynb` a mano).
- `revision/` — insumos y estado de la corrección (skill `revisar-evaluacion`).

**`version-atrasada/`** (réplica para reposición, ver entrada 2026-07-28 en `Historial.md`):
...
- `generar_evaluacion_atrasada.py` — script fuente de verdad, independiente del de `version-dia/` (contenido narrativo distinto).

- `Clase 19 - Evaluación Condicionales - Historial.md` — registro de todas las generaciones e iteraciones, de ambas versiones.
